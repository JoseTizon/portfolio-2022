        ...
        <div className='m-4'>
            ...
            <div className='text-light fs-2'>
                ...
                <div className='buttons-container'>
                    <Button variant="success" className='m-4' href='https://github.com/JoseTizon/portfolio-2022/raw/main/src/files/Jose%20Tizon%20-%20Front%20end%20Developer%202022%20(en).pdf' target='_blank'><i className="fa-solid fa-file-arrow-down"></i> CV ENG</Button>
